...
$(function() {
    ...
    var selectedFields = {!! json_encode($company->getInvoiceFields()) !!};
    var allFields = {!! json_encode($company->getAllInvoiceFields()) !!};
...
function resetFields() {
    var defaultFields = {!! json_encode($company->getDefaultInvoiceFields()) !!};
