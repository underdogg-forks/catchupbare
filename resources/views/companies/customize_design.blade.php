...
@section('content')
  ...
  <script>
    ...
    function getPDFString(cb, force) {
      ...
      invoice.company.hide_quantity = {!! Auth::user()->company->hide_quantity ? 'true' : 'false' !!};
      invoice.company.hide_paid_to_date = {!! Auth::user()->company->hide_paid_to_date ? 'true' : 'false' !!};
      NINJA.primaryColor = '{!! Auth::user()->company->primary_color !!}';
      NINJA.secondaryColor = '{!! Auth::user()->company->secondary_color !!}';
      NINJA.fontSize = {!! Auth::user()->company->font_size !!};
