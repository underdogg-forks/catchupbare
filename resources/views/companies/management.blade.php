	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				@if (Auth::user()->primaryAccount()->id != Auth::user()->company->id)
				...
				@else
					...
					@if ($planDetails && $planDetails['active'])
						...
						@if ($company->corporation->hasActiveDiscount())
							{!! Former::plaintext('discount')
									->value($company->corporation->present()->discountMessage) !!}
						@endif
				...
				<div class="modal-dialog" style="min-width:150px">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							{!! Former::plaintext(' ')
								->inlineHelp($company->corporation->present()->promoMessage) !!}
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-lg-8 col-sm-8">
						@foreach (\App\Models\Company::$modules as $entityType => $value)
						<div class="checkbox">
							<label for="modules_{{ $value}}">
								<input name="modules[]" id="modules_{{ $value}}" type="checkbox" {{ Auth::user()->company->isModuleEnabled($entityType) ? 'checked="checked"' : '' }} value="{{ $value }}">{{ trans("texts.{$entityType}s") }}
							</label>
						</div>
						@endforeach
					</div>
		...
		{!! Former::open('settings/cancel_account')->addClass('cancel-company') !!}
		<div class="panel panel-default">
			<div class="panel-heading">
