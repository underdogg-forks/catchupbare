    ...
    <script type="text/javascript">
        ...
        function updateCurrencyCodeRadio() {
            ...
            if ( ! currency || ! currency.symbol) {
                ...
                symbolExample = formatMoney(1000, currencyId, {{ Auth::user()->company->country_id ?: DEFAULT_COUNTRY }}, '{{ CURRENCY_DECORATOR_SYMBOL }}');
                codeExample = formatMoney(1000, currencyId, {{ Auth::user()->company->country_id ?: DEFAULT_COUNTRY }}, '{{ CURRENCY_DECORATOR_CODE }}');
