...
{!! Former::populateField('enable_client_portal', intval($company->enable_client_portal)) !!}
{!! Former::populateField('enable_client_portal_dashboard', intval($company->enable_client_portal_dashboard)) !!}
...
{!! Former::populateField('show_accept_invoice_terms', intval($company->show_accept_invoice_terms)) !!}
{!! Former::populateField('show_accept_quote_terms', intval($company->show_accept_quote_terms)) !!}
{!! Former::populateField('require_invoice_signature', intval($company->require_invoice_signature)) !!}
{!! Former::populateField('require_quote_signature', intval($company->require_quote_signature)) !!}

@include('companies.nav', ['selected' => COMPANY_CLIENT_PORTAL])
                        ...
                        <div class="panel-body">
                            ...
                            @if (Utils::isNinja() && ! Utils::isReseller())
                                {!! Former::inline_radios('domain_id')
                                        ...
                                        ])->check($company->domain_id)
                                        ->help($company->iframe_url ? 'domain_help_website' : 'domain_help') !!}
                            @endif
