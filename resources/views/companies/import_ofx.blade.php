...
@section('content')
    ...
    <div class="panel-body">
        ...
        {!! Former::open_for_files('bank_accs/import_ofx')
    ...
    {!! Former::actions(
        Button::normal(trans('texts.cancel'))->large()->asLinkTo(URL::to('settings/bank_accs'))->appendIcon(Icon::create('remove-circle')),
