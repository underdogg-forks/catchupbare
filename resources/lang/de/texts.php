...
$LANG = array(
    ...
    'create_new_relation' => 'Einen neuen Kunden erstellen',
    'edit_relation_details' => 'Kundendetails bearbeiten',
    'enable' => 'Aktivieren',
    ...
    'billed_relation' => 'abgerechneter Kunde',
    'billed_relations' => 'abgerechnete Kunden',
    ...
    'select' => 'Wählen',
    'edit_relation' => 'Kunde bearbeiten',
    ...
    'client_view_styling' => 'Relation View Styling',
    ...
    'created_relation' => 'Kunde erfolgreich angelegt',
    'created_relations' => ':count Kunden erfolgreich angelegt',
    ...
    'updated_relation' => 'Kunde erfolgreich aktualisiert',
    'created_relation' => 'Kunde erfolgreich angelegt',
    'archived_relation' => 'Kunde erfolgreich archiviert',
    'archived_relations' => ':count Kunden erfolgreich archiviert',
    'deleted_relation' => 'Kunde erfolgreich gelöscht',
    'deleted_relations' => ':count Kunden erfolgreich gelöscht',
    ...
    'and_created_relation' => 'und Kunde erstellt',
    ...
    'invoice_subject' => 'Neue Rechnung :invoice von :company',
    ...
    'notification_invoice_paid_subject' => 'Die Rechnung :invoice wurde von :relation bezahlt.',
    'notification_invoice_sent_subject' => 'Rechnung :invoice wurde an :relation versendet.',
    'notification_invoice_viewed_subject' => 'Die Rechnung :invoice wurde von :relation angeschaut.',
    'notification_invoice_paid' => 'Eine Zahlung von :amount wurde von :relation bezüglich Rechnung :invoice getätigt.',
    'notification_invoice_sent' => 'Rechnung :invoice über :amount wurde an den Kunden :relation versendet.',
    'notification_invoice_viewed' => 'Der Kunde :relation hat sich die Rechnung :invoice über :amount angesehen.',
    ...
    'pro_plan_success' => 'Danke, dass Sie Invoice Ninja\'s Pro gewählt haben!<p/>&nbsp;<br/>
                          ...
                          welche mit Ihrem Company verbunden ist, geschickt. Um alle der umfangreichen
    ...
    'corporation_fields' => 'Firmenfelder',
    'relation_fields' => 'Kundenfelder',
    ...
    'quote_subject' => 'Neues Angebot :quote von :company',
    ...
    'notification_quote_sent_subject' => 'Angebot :invoice wurde an :relation versendet',
    'notification_quote_viewed_subject' => 'Angebot :invoice wurde von :relation angeschaut',
    'notification_quote_sent' => 'Der folgende Kunde :relation erhielt das Angebot :invoice über :amount.',
    'notification_quote_viewed' => 'Der folgende Kunde :relation hat sich das Angebot :relation über :amount angesehen.',
    ...
    'restored_relation' => 'Kunde erfolgreich wiederhergestellt',
    ...
    'notification_quote_approved_subject' => 'Angebot :invoice wurde von :relation angenommen.',
    'notification_quote_approved' => 'Der folgende Kunde :relation nahm das Angebot :invoice über :amount an.',
    ...
    'created_payment_emailed_relation' => 'Zahlung erfolgreich erstellt und Kunde per E-Mail benachrichtigt',
    'add_corporation' => 'Konto hinzufügen',
    'untitled' => 'Unbenannt',
    'new_corporation' => 'Neues Konto',
    'associated_companies' => 'Konten erfolgreich verlinkt',
...
<p>Sollten Sie Verständnisprobleme haben, hinterlassen Sie doch bitte einen Forenbeitrag in unserem <a href="https://www.invoiceninja.com/forums/forum/support/" target="_blank">Support Forum</a> mit dem Design, welches Sie verwenden.</p>',
    ...
    'reminder_subject' => 'Erinnerung: Rechnung :invoice von :company',
    'reset' => 'Zurücksetzen',
    ...
    'type' => 'Typ',
    'activity_1' => ':user erstellte Kunde :relation',
    'activity_2' => ':user archivierte Kunde :relation',
    'activity_3' => ':user löschte Kunde :relation',
    ...
    'activity_26' => ':user stellte Kunde :relation wieder her',
    ...
    'archive_acc_gateway' => 'Gateway archivieren',
    'archived_acc_gateway' => 'Gateway erfolgreich archiviert',
    ...
    'custom_relation_fields_helps' => 'Füge ein Feld hinzu, wenn ein neuer Kunde erstellt wird und zeige die Bezeichnung und den Wert auf der PDF-Datei an.',
...
<li>Heute ist Freitag, das Fälligkeitsdatum ist der Freitag einer jeden Woche. Das nächste Fälligkeitsdatum entspricht dem nächsten Freitag, also nicht heute.
    ...
    'bank_accs' => 'Bankverbindungen',
    'add_bank_acc' => 'Bankverbindung hinzufügen',
    'setup_account' => 'Konto einrichten',
    'import_expenses' => 'Ausgaben importieren',
    'bank_id' => 'Bank',
    'integration_type' => 'Integrations-Typ',
    'updated_bank_acc' => 'Bankverbindung erfolgreich aktualisiert',
    'edit_bank_acc' => 'Bankverbindung Bearbeiten',
    'archive_bank_acc' => 'Bankverbindung Archivieren',
    'archived_bank_acc' => 'Bankverbindung erfolgreich archiviert',
    'created_bank_acc' => 'Bankverbindung erfolgreich erstellt',
    'validate_bank_acc' => 'Bankverbindung bestätigen',
    ...
    'bank_acc_error' => 'Fehler beim Abrufen der Kontodaten. Bitte überprüfen Sie Ihre Anmeldeinformationen.',
    ...
    'trial_message' => 'Ihr Company erhält zwei Wochen Probemitgliedschaft für unseren Pro-Plan.',
    ...
    'bank_accs_help' => 'Fügen Sie eine Bankverbindung hinzu, um Ausgaben automatisch zu importieren und Lieferanten zu erstellen. Unterstützt American Express und <a href=":link" target="_blank">400+ US-Banken.</a>',
    ...
    // Plans
    'account_management' => 'Company Verwaltung',
    ...
    'add_users_not_supported' => 'Führen Sie ein Upgrade auf den Enterprise-Plan durch, um zusätzliche Nutzer zu Ihrem Company hinzufügen zu können.',
    ...
    'invalid_acc_number' => 'Die Kontonummer ist nicht gültig.',
    'acc_number_mismatch' => 'Die Kontonummern stimmen nicht überein.',
    ...
    'confirm_acc_number' => 'Kontonummer bestätigen',
    'individual_account' => 'Einzelkonto',
    'corporation_account' => 'Firmenkonto',
    ...
    'bank_acc_verification_help' => 'Wir haben zwei Überweisungen auf Ihr Konto mit dem Verwendungszweck "VERIFICATION" getätigt. Diese Überweisungen werden 1-2 Werktage benötigen, bis sie auf Ihrem Kontoauszug zu sehen sind. Bitte geben Sie die Überweisungssummen unten ein.',
    'bank_acc_verification_next_steps' => 'Wir haben zwei Überweisungen auf Ihr Konto mit dem Verwendungszweck "VERIFICATION" getätigt. Diese Überweisungen werden 1-2 Werktage benötigen, bis sie auf Ihrem Kontoauszug zu sehen sind.
Sobald Sie die Beträge erhalten haben, kommen Sie bitte wieder zurück zu dieser Zahlungsmethoden-Seite und klicken Sie auf "Complete Verification" neben Ihrem Konto.',
    ...
    'notification_invoice_payment_failed' => 'Eine Zahlung Ihres Kunden :relation für die Rechnung :invoice schlug fehl. Die Zahlung wurde als Fehlgeschlagen markiert und :amount wurde dem Saldo Ihres Kunden hinzugefügt.',
    ...
    'ach_authorization' => 'Ich autorisiere :corporation mein Bankkonto für künftige Zahlungen zu nutzen und, falls nötig, elektronisch mein Konto zu belasten, um falsche Abbuchungen korrigieren zu können. Ich bestätige verstanden zu haben, dass ich diese Autorisierung jederzeit durch Entfernung dieser Zahlungsmethode oder durch Kontaktaufnahme mit :email zurücknehmen kann.',
    ...
    'corporation_name' => 'Firmenname',
    'wepay_corporation_name_help' => 'Das erscheint auf den Kontoauszügen des Kunden.',
    ...
    'manage_account' => 'Company managen',
    ...
    'switch' => 'Switch',
    'restore_acc_gateway' => 'Zahlungsanbieter wiederherstellen',
    'restored_acc_gateway' => 'Zahlungsanbieter erfolgreich wiederhergestellt',
    ...
    'no_relation_selected' => 'Bitte wählen Sie einen Kunden',
    ...
    'invoice_for_client' => 'Rechnung :invoice für :relation',
    ...
    'bot_get_email' => 'Hi! (wink)<br/>Danke für den Test des Invoice Ninja Bots.<br/>Sie benötigen einen kostenlosen Company auf <a href="https://www.invoiceninja.com">invoiceninja.com</a> um diesen Bot zu nutzen.<br/>Sende mir die E-Mail-Adresse deines Accounts um zu starten.',
    'bot_get_code' => 'Danke! Ich habe dir eine E-Mail mit deinem Sicherheitscode geschickt.',
    'bot_welcome' => 'Das war es schon, dein Company ist verifiziert.<br/>',
    'email_not_found' => 'Ich konnte keinen verfügbaren Company für :email finden',
    ...
    'unnamed_relation' => 'Unbenannter Kunde',
