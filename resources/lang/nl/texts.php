...
$LANG = array(
    ...
    'confirmation_message' => 'Klik op onderstaande link om uw company te bevestigen.',
    'invoice_subject' => 'Nieuwe factuur :invoice van :company',
    ...
    'reset_password' => 'U kunt het wachtwoord van uw company resetten door op de volgende link te klikken:',
    ...
    'quote_subject' => 'Nieuwe offerte :quote van :company',
    ...
    'cancel_account' => 'Company opzeggen',
    ...
    'gateway_help_27' => ':link om aan te melden voor 2Checkout.com. Om te verzekeren dat betalingen gevolgd worden stel :complete_link in als de redirect URL onder Company > Site Management in het 2Checkout portaal.',
    ...
    'associated_companies' => 'Accounts succesvol gekoppeld',
    ...
    'unlink_account' => 'Koppel company los',
    'unlink' => 'Koppel los',
...
<p>Als je ergens hulp bij nodig hebt, stel dan een vraag op ons <a href="https://www.invoiceninja.com/forums/forum/support/" target="_blank">support forum</a>.</p>',
    ...
    'reminder_subject' => 'Herinnering: Factuur :invoice van :company',
    'reset' => 'Reset',
    ...
    'customize' => 'Aanpassen',
    'oneclick_login_help' => 'Verbind een company om zonder wachtwoord in te kunnen loggen',
    ...
    'archive_acc_gateway' => 'Archiveer betalingsverwerker',
    'archived_acc_gateway' => 'Betalingsverwerker succesvol gearchiveerd',
    ...
    'bank_accs' => 'Bankrekeningen',
    'add_bank_acc' => 'Bankrekening toevoegen',
    'setup_account' => 'Rekening instellen',
    'import_expenses' => 'Uitgaven importeren',
    'bank_id' => 'Bank',
    'integration_type' => 'Integratie Type',
    'updated_bank_acc' => 'Bankrekening succesvol bijgewerkt',
    'edit_bank_acc' => 'Bewerk bankrekening',
    'archive_bank_acc' => 'Archiveer bankrekening',
    'archived_bank_acc' => 'Bankrekening succesvol gearchiveerd',
    'created_bank_acc' => 'Bankrekening succesvol toegevoegd',
    'validate_bank_acc' => 'Bankrekening valideren',
    ...
    'acc_number' => 'Rekeningnummer',
    'acc_name' => 'Rekeninghouder',
    'bank_acc_error' => 'Het ophalen van rekeninggegevens is mislukt, controleer uw inloggegevens.',
    ...
    'trial_message' => 'Uw company zal een gratis twee weken durende probeerversie van ons pro plan krijgen.',
    ...
    'bank_accs_help' => 'Koppel een bankrekening om automatisch uitgaven en leveranciers te importeren. Ondersteund American Express en <a href=":link" target="_blank">400+ banken uit de VS.</a>',
    ...
    'email_error_user_unregistered' => 'Registreer een company om e-mails te kunnen versturen',
    'email_error_user_unconfirmed' => 'Bevestig uw company om e-mails te kunnen versturen',
    ...
    'add_users_not_supported' => 'Upgrade naar het zakelijke abonnement om extra gebruikers toe te voegen aan uw company.',
    ...
    'invalid_acc_number' => 'Het rekeningnummer is niet juist.',
    'acc_number_mismatch' => 'De rekeningnummers komen niet overeen.',
    ...
    'confirm_acc_number' => 'Bevestig rekeningnummer',
    'individual_account' => 'Persoonlijke rekening',
    'corporation_account' => 'Bedrijfsrekening',
    ...
    'bank_acc_verification_help' => 'We hebben twee bedragen met de omschrijving "VERIFICATION" overgeboekt naar uw rekening. Het duurt 1 à 2 werkdagen voordat deze overschrijvingen zichtbaar zijn op uw afschriften. Voer de bedragen hieronder in.',
    'bank_acc_verification_next_steps' => 'We hebben twee bedragen met de omschrijving "VERIFICATION" overgeboekt naar uw rekening. Het duurt 1 à 2 werkdagen voordat deze overschrijvingen zichtbaar zijn op uw afschriften.
Kom terug naar deze betalingsmethode pagina zodra u de bedragen heeft ontvangen en klik op "Verificatie voltooien" direct naast de rekening.',
    ...
    'ach_authorization' => 'Ik geef :corporation toestemming om mijn bankrekening te gebruiken voor toekomstige betalingen en, indien nodig, te crediteren op mijn rekening om foutieve afschrijvingen te corrigeren. I begrijp dat ik deze toestemming te allen tijde mag annuleren door de betalingsmethode te verwijderen of door contact op te nemen via :email.',
    ...
    'braintree_paypal_help_link_text' => 'PayPal koppelen aan uw BrainTree company',
    ...
    'wepay_description_help' => 'De reden van deze company.',
    ...
    'manage_account' => 'Company beheren',
    ...
    'restore_acc_gateway' => 'Gateway herstellen',
    'restored_acc_gateway' => 'Gateway succesvol hersteld',
...
',
    ...
    'no_relation_selected' => 'Gelieve een klant te selecteren',
    ...
    'invoice_for_client' => 'Factuur :invoice voor :relation',
    ...
    'bot_get_email' => 'Hallo! (wave)<br/>bedankt om de Invoice Ninja Bot uit te proberen.<br/>Je moet een gratis company aanmaken op  <a href="https://www.invoiceninja.com">invoiceninja.com</a> om de bot te kunnen gebruiken.<br/>Stuur me uw e-mailadres om van start te gaan.',
    'bot_get_code' => 'Bedankt! Ik heb u een e-mail gestuurd met uw beveiligingscode.',
    'bot_welcome' => 'Dat was het, uw company is geverifieerd.<br/>',
    'email_not_found' => 'Ik was niet in staat om een beschikbaar company te vinden voor :email',
    ...
    'unnamed_relation' => 'Onbenoemde klant',
...
<ul><i>Flexibele zakelijke kredietlijnen en factuur factoring.</li></ul>',
	'bluevine_create_account' => 'Company aanmaken',
