...
$LANG = array(
    ...
    'create_new_relation' => 'Crear nuevo cliente',
    'edit_relation_details' => 'Editar detalles del cliente',
    'enable' => 'Activar',
    'learn_more' => 'Saber más',
    'manage_rates' => 'Gestionar tarifas',
    'note_to_relation' => 'Nota para el cliente',
    ...
    'billed_relation' => 'Cliente Facturado',
    'billed_relations' => 'Clientes Facturados',
    ...
    'created_relation' => 'cliente creado con éxito',
    'created_relations' => ':count clientes creados con éxito',
    ...
    'updated_relation' => 'Cliente actualizado correctamente',
    'created_relation' => 'cliente creado con éxito',
    'archived_relation' => 'Cliente archivado correctamente',
    'archived_relations' => ':count clientes archivados correctamente',
    'deleted_relation' => 'Cliente eliminado correctamente',
    'deleted_relations' => ':count clientes eliminados correctamente',
    ...
    'and_created_relation' => 'y cliente creado ',
    ...
    'invoice_subject' => 'Nueva factura :invoice de :company',
    ...
    'notification_invoice_paid_subject' => 'La factura :invoice ha sido pagada por el cliente :relation',
    'notification_invoice_sent_subject' => 'La factura :invoice ha sido enviada a el cliente :relation',
    'notification_invoice_viewed_subject' => 'La factura :invoice ha sido visualizado por el cliente:relation',
    'notification_invoice_paid' => 'Un pago por importe de :amount ha sido realizado por el cliente :relation correspondiente a la factura :invoice.',
    'notification_invoice_sent' => 'La factura :invoice por importe de :amount fue enviada al cliente :cliente.',
    'notification_invoice_viewed' => 'La factura :invoice por importe de :amount fue visualizada por el cliente :relation.',
    ...
    'corporation_fields' => 'Campos de la empresa',
    'relation_fields' => 'Campos del cliente',
    ...
    'quote_subject' => 'New quote :quote from :company',
    ...
    'notification_quote_sent_subject' => 'El presupuesto :invoice enviado al cliente :relation',
    'notification_quote_viewed_subject' => 'El presupuesto :invoice fue visto por el cliente :relation',
    'notification_quote_sent' => 'El presupuesto :invoice por un valor de :amount, ha sido enviado al cliente :relation.',
    'notification_quote_viewed' => 'El presupuesto :invoice por un valor de :amount ha sido visto por el cliente :relation.',
    ...
    'restored_relation' => 'Cliente restaurada con éxito',
    ...
    'notification_quote_approved_subject' => 'Presupuesto :invoice fue aprobado por :relation',
    'notification_quote_approved' => 'El cliente :relation aprovó el presupuesto :invoice por :amount.',
...
Acceder a 10 hermosos diseños de Factura',
    ...
    'created_payment_emailed_relation' => 'Pago creado y enviado al cliente correctamente',
    'add_corporation' => 'Añadir compañía',
    'untitled' => 'Sin Título',
    'new_corporation' => 'Nueva compañía',
    'associated_companies' => 'Vínculo de cuentas correcta',
    ...
    'reminder_subject' => 'Recordatorio: Factura :invoice de :company',
    'reset' => 'Reiniciar',
    ...
    'type' => 'Tipo',
    'activity_1' => ':user creó el cliente :relation',
    'activity_2' => ':user archivó el cliente :relation',
    'activity_3' => ':user borró el cliente :relation',
    ...
    'activity_26' => ':user restauró el cliente :relation',
    ...
    'archive_acc_gateway' => 'Archivar Pasarela',
    'archived_acc_gateway' => 'Pasarela archivada',
    ...
    'custom_relation_fields_helps' => 'Añadir un campo al crear un cliente y mostrar la etiqueta y su valor en el PDF.',
    ...
    'bank_accs' => 'Cuentas Bancarias',
    'add_bank_acc' => 'Añadir Cuenta Bancaria',
    'setup_account' => 'Configurar Cuenta',
    'import_expenses' => 'Importar Gastos',
    'bank_id' => 'Banco',
    'integration_type' => 'Tipo de Integración',
    'updated_bank_acc' => 'Cuenta Bancaria actualizada correctamente',
    'edit_bank_acc' => 'Editar Cuenta Bancaria',
    'archive_bank_acc' => 'Archivar Cuenta Bancaria',
    'archived_bank_acc' => 'Cuenta Bancaria archivada correctamente',
    'created_bank_acc' => 'Cuenta Bancaria creada correctamente',
    'validate_bank_acc' => 'Validar Cuenta Bancaria',
...
Atención! tu password puede estar transmitida como texto plano, considera habilitar HTTPS.',
    ...
    'bank_acc_error' => 'Error al recuperar los detalles de la cuenta, por favor revisa tus credenciales.',
    ...
    'white_label_text' => 'Purchase a ONE YEAR white label license for $:price to remove the Invoice Ninja branding from the invoice and relation portal.',
    ...
    'bank_accs_help' => 'Connect a bank company to automatically import expenses and create vendors. Supports American Express and <a href=":link" target="_blank">400+ US banks.</a>',
    ...
    'enable_client_portal_help' => 'Show/hide the dashboard page in the relation portal.',
    ...
    'invalid_acc_number' => 'The company number is not valid.',
    'acc_number_mismatch' => 'The company numbers do not match.',
    'missing_account_holder_type' => 'Please select an individual or corporation company.',
    'missing_account_holder_name' => 'Please enter the company holder\'s name.',
    'routing_number' => 'Routing Number',
    'confirm_acc_number' => 'Confirm Company Number',
    'individual_account' => 'Individual Company',
    'corporation_account' => 'Corporation Company',
    'account_holder_name' => 'Company Holder Name',
    'add_account' => 'Add Company',
    ...
    'bank_acc_verification_help' => 'We have made two deposits into your company with the description "VERIFICATION". These deposits will take 1-2 business days to appear on your statement. Please enter the amounts below.',
    'bank_acc_verification_next_steps' => 'We have made two deposits into your company with the description "VERIFICATION". These deposits will take 1-2 business days to appear on your statement.
    ...
    'plaid_linked_status' => 'Your bank company at :bank',
    'add_payment_method' => 'Add Payment Method',
    'account_holder_type' => 'Company Holder Type',
    'ach_authorization' => 'I authorize :corporation to use my bank company for future payments and, if necessary, electronically credit my company to correct erroneous debits. I understand that I may cancel this authorization at any time by removing the payment method or by contacting :email.',
    ...
    'add_paypal_account' => 'Add PayPal Company',
    ...
    'corporation_name' => 'Nombre de la Empresa',
    ...
    'switch' => 'Cambiar',
    'restore_acc_gateway' => 'Restore Gateway',
    'restored_acc_gateway' => 'Successfully restored gateway',
    ...
    'export_help' => 'Use JSON if you plan to import the data into Invoice Ninja.<br/>The file includes relations, products, invoices, quotes and payments.',
    'JSON_file' => 'JSON File',
    ...
    'auto_bill_payment_method_bank_transfer' => 'bank company',
    ...
    'bot_get_email' => 'Hi! (wave)<br/>Thanks for trying the Invoice Ninja Bot.<br/>You need to create a free company on <a href="https://www.invoiceninja.com">invoiceninja.com</a> to use this bot.<br/>Send me your company email address to get started.',
    ...
    'limited_gateways' => 'Note: we support one credit card gateway per corporation.',
    ...
    'account_fields' => 'Corporation Fields',
    ...
    'show_accept_invoice_terms_help' => 'Require relation to confirm that they accept the invoice terms.',
    'show_accept_quote_terms' => 'Quote Terms Checkbox',
    'show_accept_quote_terms_help' => 'Require relation to confirm that they accept the quote terms.',
    'require_invoice_signature' => 'Invoice Signature',
    'require_invoice_signature_help' => 'Require relation to provide their signature.',
    'require_quote_signature' => 'Quote Signature',
    'require_quote_signature_help' => 'Require relation to provide their signature.',
...
<ul><li>Flexible business lines of credit and invoice factoring.</li></ul>',
    ...
    'logged_in' => 'Logged In',
    'switch_to_primary' => 'Switch to your primary corporation (:name) to manage your plan.',
    'inclusive' => 'Inclusive',
    'exclusive' => 'Exclusive',
    ...
    'next_client_number' => 'The next relation number is :number.',
    ...
    'bcc_email' => 'BCC Email',
    'bcc_email_help' => 'All emails sent to your relations will also be sent to this address.',
    'tax_quote' => 'Tax Quote',
    ...
    'domain' => 'Domain',
    'domain_help' => 'Used in the relation portal and when sending emails.',
